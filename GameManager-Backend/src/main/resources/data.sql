...
INSERT INTO employee(email, name, password)
SELECT 'employee1@mail.com', 'employee', 'c775e7b757ede630cd0aa1113bd102661ab38829ca52a6422ab782862f268646'
WHERE NOT EXISTS (SELECT 1 FROM owner WHERE email = 'employee1@mail.com');
...
SELECT 0, 'Embark on an odyssey for the Lost Ark in a vast, vibrant world: explore new lands, seek out lost treasures, and test yourself in thrilling action combat in this action-packed free-to-play RPG.', 1, 'action', 0, 33.99, 0, 100, 'Lost Ark', (SELECT category_id FROM category WHERE name = 'Action'), 'https://shared.cloudflare.steamstatic.com/store_item_assets/steam/apps/1599340/header.jpg?t=1728605858'
    WHERE NOT EXISTS (SELECT 1 FROM game WHERE game_id = 17);
INSERT INTO game(average_rating, description, game_status, genre, popularity, price, request_status, stock, title, category, image_url)
SELECT 0, 'Open your own local game store. Stock shelves with the latest booster packs, or crack them and collect the cards for yourself. Set your own prices, hire staff, host events, and expand your card shop.', 1, 'strategy', 0, 16.99, 0, 100, 'TCG Card Shop Simulator',(SELECT category_id FROM category WHERE name = 'Strategy'), 'https://shared.cloudflare.steamstatic.com/store_item_assets/steam/apps/3070070/header.jpg?t=1729839700'
    WHERE NOT EXISTS (SELECT 1 FROM game WHERE game_id = 18);
INSERT INTO game(average_rating, description, game_status, genre, popularity, price, request_status, stock, title, category, image_url)
SELECT 0, 'Grand Theft Auto V for PC offers players the option to explore the award-winning world of Los Santos and Blaine County in resolutions of up to 4k and beyond, as well as the chance to experience the game running at 60 frames per second.', 1, 'racing', 0,29.98, 0, 100,'Grand Theft Auto V', (SELECT category_id FROM category WHERE name = 'Racing'), 'https://shared.cloudflare.steamstatic.com/store_item_assets/steam/apps/271590/header.jpg?t=1726606628'
